const data = {
    myStory : {
        part1: "My name is Iskak. I am a full stack engineer who loves both frontend and backend development. I often find myself absorbed in my projects when facing new challenges, and excited when I solve them. I'm fascinated with libraries like React for frontend development and Redux for state management, and web frameworks like Express (Node.js) for backend. I’m eager to also learn languages such as TypeScript, Python, C#, C++, and new frameworks like GraphQL and more.",
        ...
        part3: "In September 2019, I started self-directed online courses with Udemy in HTML, CSS and JavaScript, and wrote my very first line of code, which displayed 'Hello, world!'. Excited and encouraged to learn more, I entered Fullstack Academy bootcamp six months later. In my first week, I felt completely overwhelmed. But I was determined not to give up. In April 2020, I was assigned my first solo project to build a single-page application. I was nervous but as my project progressed, my confidence grew. Each challenge made me learn something new about how an object-relational database system works, how React and Redux and other libraries work, and what’s happening with them behind the scenes. In the bootcamp’s final six weeks, I completed three full-stack projects and learned more about coding with Express, PostgreSQL, React and Redux, and new technologies like React-Native, Expo.io and Chart.js, while working in immersive paired and team environments. As a developer, I am excited to bring my experience and knowledge to a work environment where I can learn even more about coding and improve my skills."
    },
   ...
   hobbies: [
    {id: 1, text: "When I am not coding, I’m trying new recipes, reading articles from my favorite publications, or enjoying my favorite sports."},
    {id: 2, text: "When I was child I learned cooking from my mom and sister. They told me that it would always be a practical skill to have to be independent. Upon arrival in the USA, I have discovered so many cuisines such as Mexican, Indian, Italian, Thai and of course American, and each of them was so delicious that it triggered a desire to learn to cook them myself. I started watching some videos and taught myself how to cook many of the dishes I tried. I call Gordon Ramsay and Jamie Oliver my virtual mentors. I cook at least five times a week and truly enjoy it."},
    {id: 3, text: "I also enjoy reading articles about news, travel, sports, science, technology, the entertainment industry, and more. I believe it is important to stay informed and to gain new knowledge. I particularly like reading the articles of BBC News, The Guardian, The Independent, and National Geographic Magazine."},
    {id: 4, text: "I also have a love for sports, especially tennis and figure skating. I am fascinated by the strength and resilience of most athletes like young figure skaters Alysa Liu, Kamila Valieva, and Rika Kihira, who are able to execute triple-axels and quad jumps, or tennis players like Serena Williams and Roger Federer who keep playing professional tennis in their late 30s and 40s while staying among the top 10 players. But I do not just watch sports. For me, staying physically active is also important. Working out at the gym and running are part of my weekly routine, and I would like to learn to play tennis, too."},

   ],

}

module.exports = {myStory : data.myStory, education: data.education, projects: data.projects, hobbies: data.hobbies}